...
namespace Assignment_UWP_DinhVanHoangAn.Pages.MasterPages
{
    /// <summary>
        ...
        private readonly List<(string Tag, Type Page)> _pages = new List<(string Tag, Type Page)>
{
    ...
    ("login", typeof(Pages.AuthenticationPages.LoginPage)),
    ("accountInfo", typeof(Pages.AuthenticationPages.AccountInfoPage)),
};
        ...
        private void NavView_Loaded(object sender, RoutedEventArgs e)
        {
            ...
            _pages.Add(("content", typeof(Pages.AuthenticationPages.LoginPage)));
        ...
        private void NavView_Navigate(string navItemTag, NavigationTransitionInfo transitionInfo)
        {
            ...
            {
                _page = typeof(SettingPages.SettingPage);
            }
            else
            {
        ...
        private void On_Navigated(object sender, NavigationEventArgs e)
        {
            ...
            if (ContentFrame.SourcePageType == typeof(SettingPages.SettingPage))
            {
